...
- Licensing is no longer required for individual use.  If no license information is found, Fabric starts with the message ÅgLicensed for individual use onlyÅh and there is no longer a pause when starting up.
