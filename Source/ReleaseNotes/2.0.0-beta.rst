...
- Tip: In Canvas all inputs are also outputs as this helps control sequencing of operations.  For instance, you can more easily insert a ÅgreportÅh node between two nodes to see what the value is.
